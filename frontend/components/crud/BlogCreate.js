...
import { getTag, getTags} from '../../actions/tag';
import { createBlog } from '../../actions/blog';
import { set } from 'js-cookie';
//import * as ReactQuill from 'react-quill';
const ReactQuill = dynamic(() => import('react-quill'), {ssr: false});
//import '../../node_module/react-quill/dist/quill.snow.css';
...
const CreateBlog = ({ router }) => {
    ...
    const showError = () => {
        <div className="alert alert-danger" styles={{display : error? '' : 'none'}}>
            {error}
            </div>
    ...
    const showSuccess = () => {
        <div className="alert alert-success" styles={{display : success? '' : 'none'}}>
            {success}
            </div>
    ...
    return (
         <div className="container-fluid">
             ...
             <p style = {{color: 'green'}}>{values.success}</p>
       <div className="row">
